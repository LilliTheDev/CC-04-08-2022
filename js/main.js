...
//Arrow function
//Declare a variable to calculate miles possible with mpg and current fuel left (in gallons)
//Make If-else to check if distance to pump matches miles possible
//Return result

const zeroFuel = (distanceToPump, mpg, fuelLeft) => {
  let milesPossible = mpg * fuelLeft
  if (distanceToPump <= milesPossible){
    return true
  } else {
    return false
  }
...
console.log(zeroFuel(10, 25, 3), true);
